...
class ReleaseGen:
    ...
    def __init__(self, github_token:str, dry_run:bool=False):
        ...
        self.releases_url = f'{self.url}/repos/thought-machine/please/releases'
        ...
        self.version_name = f'Version {self.version}'
    ...
    def needs_release(self):
        ...
        url = f'{self.releases_url}/tags/v{self.version}'
    ...
    def upload(self, artifact:str):
        ...
        filename = os.path.basename(artifact).replace(
            self.version, f'{self.version}_{arch}'
        )
    ...
    def get_release_notes(self):
        ...
        for line in self.read_file('ChangeLog').split('\n'):
            if line.startswith(self.version_name):
                found_version = True
                yield f'This is Please v{self.version}'
